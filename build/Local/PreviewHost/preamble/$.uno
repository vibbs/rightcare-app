...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.0.22"), 12124)}, "/Users/vibbs/workspace/rightcare/rightcare-native/rightcare-native.unoproj", GetBundle, new string[] { ""})
{
...
{
return Uno.IO.Bundle.Get("rightcare-native");
}
}
}
